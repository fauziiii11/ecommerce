...
Welcome to our store. Whatever shopping you want, Happy shopping and Thank you.</p>
  <div class="mt-6 flex justify-center space-x-2">
    <button class="rounded-lg bg-gray-50 px-2 py-1 font-medium text-gray-900 hover:bg-gray-200">product</button>
    <button class="rounded-lg bg-gray-50 px-2 py-1 font-medium text-gray-900 hover:bg-gray-200">Kategori</button>
    <button class="rounded-lg bg-gray-50 px-2 py-1 font-medium text-gray-900 hover:bg-gray-200">Contact</button>
  </div>
...
<br>
<h1 class="mt-2 text-5xl font-extrabold text-black text-center mt-9">SALE!!!</h1>
