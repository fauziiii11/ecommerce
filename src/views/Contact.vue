  ...
  <div class="mx-auto mb-20 flex w-full max-w-screen-lg flex-col overflow-hidden rounded-xl text-gray-900 md:flex-row md:border md:shadow-lg">
    <form class="mx-auto w-full max-w-xl border-gray-200 px-10 py-8 md:px-8">
      ...
      <div class="flex items-center">
        ...
        <button class="rounded-xl bg-gray-600 px-4 py-3 text-center font-bold text-white hover:bg-gray-700" type="submit">Send message</button>
      </div>
    </form>
    <div class="mt-10 bg-gray-600 px-10 py-8 text-gray-100 md:mt-0 md:ml-auto">
      <div class="">
        ...
        <p class="mb-4">
          Email:
          <a href="#" class="font-semibold underline">fauzi@gmail.com</a>
        </p>
        <p class="mb-4">
          Phone:
          <a href="#" class="font-semibold underline">082126915430</a>
        </p>
