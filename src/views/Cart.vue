          ...
          <div class="flow-root">
            <ul class="-my-8">
              <li class="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                <div class="shrink-0">
                  <img class="h-24 w-24 max-w-full rounded-lg object-cover" src="https://www.specs.id/media/catalog/product/s/p/spe200779-1.jpg?optimize=high&bg-color=255,255,255&fit=bounds&height=330&width=330&canvas=330:330" alt="" />
                </div>
