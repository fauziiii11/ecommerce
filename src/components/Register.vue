    ...
    <div class="w-full sm:w-3/5">
      <div class="p-8">
        ...
        <form class="mt-8">
          ...
          <input class="mt-4 w-full cursor-pointer rounded-lg bg-indigo-600 pt-3 pb-3 text-white shadow-lg hover:bg-indigo-400" type="submit" value="Create account" @click="submit" />
        </form>
        <div class="mt-4 text-center">
          <p class="text-sm text-gray-600">Already have an account? <a href="#" class="font-bold text-indigo-600 no-underline hover:text-indigo-400"><router-link to="/login">Sign In</router-link></a></p>
        </div>
      </div>
    </div>
  </div>
